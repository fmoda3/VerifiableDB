# Django settings for VerifiableDB project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Karen', 'kasittig@gmail.com'),
)
...
SECRET_KEY = 'plof#-tr+b1mnebyzqpeiv$frz2--0&#jx@(l(3wi09vdvk&n3'
...
ROOT_URLCONF = 'VerifiableDB.urls'
